...
$doc->addScript(JURI::root(true).'/modules/mod_jm_simple_tabs/assets/script.js');
...
$breakpoint = ( $responsive_view == 1 ) ? 'data-breakpoint="'. $params->get('responsive_breakpoint', 767) . '"' : '';
